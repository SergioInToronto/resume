...
\sectionline
    ...
    \begin{list2}
        \item Owned high-throughput systems (Helios, Conduit) for supplying AI teams' models with data
        \vspace{1mm}
        ...
        \vspace{1mm}
        \item Inherited a major project from a departing principal engineer. Deciphered \textit{highly complex} Clickhouse queries to address shortcomings of the original design. Successfully migrated all clients
        \vspace{1mm}
        \item\textbf{Tech:} Claude Code, Elixir, Clickhouse, gRPC, envoy-proxy, Terraform, Cortex
    \end{list2}


    \hspace{2.6mm}\textbf{Senior Developer} \hfill \textbf{Dec 2023 -- July 2025}\vspace{1mm}
    \begin{list2}
        \item Designed and built an analytics framework that reduced change effort from \textit{weeks} to \textit{hours} while also adding new capabilities
        \vspace{1mm}
