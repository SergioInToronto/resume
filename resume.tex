...
\sectionline
    ...
    \begin{list2}
        ...
        \vspace{1mm}
        \item\textbf{Tech:} Python, JavaScript ES6/ES7, Java, Splunk, JReport, RabbitMQ, Docker
    \end{list2}
...
\sectionline
    ...
    \begin{list2}
        ...
        \item Experienced with others including: TypeScript, C\#, Java, and Go
    \end{list2}\vspace{-1.5mm}
    ...
    \begin{list2}
        ...
        \item Skilled with Ruby on Rails. Familiarity with Django
    ...
    \begin{list2}
        ...
        \item Experience querying Splunk, Datadog, and various NoSQL databases
        \item Experience with issue-tracking systems: GitHub, GitLab, and Jira
        \item Previously used Heroku, AWS, Kubernetes + Helm, and other systems for production deployments
        \item Expert knowledge of networking. Formerly CCNA certified
