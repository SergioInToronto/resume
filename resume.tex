...
\sectionline
    ...
    \begin{list2}
        ...
        \vspace{1mm}
        \item Took over a major migration from a departing principal engineer. Learned Elixir, gRPC, and Clickhouse. Rangled \textit{incredibly} complex Clickhouse-specific SQL to address major shortcomings of the original design. Ultimately migrated all clients to the new system.
        \vspace{1mm}
    ...
    \textbf{Tech:} Elixir, Clickhouse, gRPC, envoy-proxy, Terraform, Cortex
