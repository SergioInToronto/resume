...
\sectionline
    ...
    \begin{list2}
        ...
        \vspace{1mm}
        \item Created OpsLevel integrations for: Jenkins, Datadog, Terraform, Jira, Spotify Backstage, AWS ECR, Opsgenie, and others
        \vspace{1mm}
        \item Recently lead the rewrite of a \textit{very complex} query, resulting in a 90x performance improvement
        \vspace{1mm}
        \item Responsibilities included: system design, collaborating to build/enhance features, code reviews, production support, solving difficult problems, and mentoring others
        \vspace{1mm}
    ...
    \begin{list2}
        ...
        \vspace{1mm}
        \item Facilitated collaboration between designers, developers, product owners, and stakeholders
        \vspace{1mm}
