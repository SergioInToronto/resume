...
\opening
    ...
    \begin{list2}
        ...
        \vspace{3mm}
        \item Professional experience with: Ruby on Rails, Flask, Golang, SQL \& NoSQL, Redis, Memcache, RabbitMQ, Sidekiq, Terraform, Kubernetes \& Helm, and various issue-tracking systems (GitHub, GitLab, Jira, Monday.com).
    \end{list2}\vspace{-1.5mm}
