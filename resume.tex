...
\sectionline
    ...
    \begin{list2}
        \item Tech Lead is a rotating role at OpsLevel - I successfully lead projects building features and integrations for OpsLevel's core SaaS product
        \vspace{1mm}
        \item Recently lead the rewrite of a \textit{very complex} query, resulting in a 90x performance improvement
        \vspace{1mm}
        \item Responsibilities included: system design, colaborating to build/enhance features, code reviews, production support, ETLs, and mentoring others
        \vspace{1mm}
...
\sectionline
    ...
    \begin{list2}
        ...
        \item Professional experience with others including: TypeScript, C\#, Java, Go, and Rust
    \end{list2}\vspace{-1.5mm}
    ...
    \begin{list2}
        ...
        \item Excellent knowledge of computer networking. CCNA certification achieved
