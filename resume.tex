...
\sectionline
    ...
    \begin{list2}
        \item Delivered full-stack features for OpsLevel's internal developer portal (IDP)
        ...
        \item Recently rewrote a \textit{very complex} query that improved performance nearly 100x
        \item Frequently collaborated with people outside my team, including directly with customers or prospects, to deliver exactly the right solution
    \end{list2}
